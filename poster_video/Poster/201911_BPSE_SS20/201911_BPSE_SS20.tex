...
\newcommand{\publishdate}{30.11.2019}
\newcommand{\publisher}{Kurz, EST, www.fbi.h-da.de}

\documentclass[%
textcolor=HDA_lightblue,	% sets the default textcolor (defines '\stdtextcolor')
...
\begin{document}
% \placegraphics{50}{0}{0}{../../../visuals/backgroundBig_Washed.png} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}
\draw [draw=none, fill=HDA_blue] (0,0) circle [radius=\textwidth];
\end{tikzpicture}
\end{textblock}
...
\titleblock{\textcolor{HDA_gray_0}{Bachelor PSE}} % title
\subtitleblock{\textcolor{HDA_gray_0}{\textbf{RADACC}}}
...
\estlogo{LG0_est_w1111.eps}		% logo at upper right corner
\fbilogo{LG0_fbi_w1111_engl.eps}	% logo at lower left corner
...
\placegraphics{12.5}{2}{21.25}{../../../visuals/RADACC_schmal.png} 
